...
# Kill servers
kill 95400 2>/dev/null && echo "✅ PHP server stopped" || echo "⚠️  PHP server was not running"
kill 95312 2>/dev/null && echo "✅ React Remote stopped" || echo "⚠️  React Remote was not running"
